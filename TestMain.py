...
from Models.CNN import CNN, GuardCNN, CifarCNN, Net
...
class TestMain(unittest.TestCase):
    ...
    def test_main(self, algo="fedCam", attack_type="NoAttack", attacker_ratio=0.3):
        random.seed(42)
        print("started")
...
if __name__ == "__main__":
    ...
    if args.algo:
        test_instance.test_main(algo=args.algo, attack_type=args.attack, attacker_ratio=args.ratio)
    else:
